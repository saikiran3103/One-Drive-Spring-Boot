...
public class MetaDataForSharedItem implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8866177106616899311L;
     ...
     */
    private ParentRefernceForSharedItem parentReference;
	...
	public String toString() {
		return "MetaDataForSharedItem [id=" + id + ", name=" + name + ", createdBy=" + createdBy + ", createdDateTime="
				...
				+ ", parentReference=" + parentReference + ", rawJson=" + rawJson + ", folder=" + folder
	 ...
	 */
	public ParentRefernceForSharedItem getParentReference() {
	 ...
	 */
	public void setParentReference(ParentRefernceForSharedItem parentReference) {
