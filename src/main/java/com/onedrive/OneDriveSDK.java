...
public interface OneDriveSDK {
     ...
     * @throws ParseException 
     */
    OneFolder getRootFolder(OneDrive drive) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFolder getFolderById(String id) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFolder getFolderByPath(String pathToFolder) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFile getFileById(String id) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFile getFileByPath(String pathToFile) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFolder getFolderByPath(String pathToFolder, OneDrive drive) throws IOException, OneDriveException, ParseException;
     ...
     * @throws ParseException 
     */
    OneFile getFileByPath(String pathToFile, OneDrive drive) throws IOException, OneDriveException, ParseException;
